...
7. Set Backend URL to `https://orbit-backend-production-26a0.up.railway.app`
8. Click **Save** — you should see "Agent Active" with a green dot
...
| **Sync Current Page Now** | Manually trigger a sync immediately |
...
- Check that your backend URL is correct in settings
- Visit `{backendURL}/health` in browser — should return `{"status":"ok"}`
- Make sure your Railway deployment is running

**No Chrome notification after chatting**
- Make sure you mentioned job-related keywords (job, intern, role, apply, etc.)
- Check that "Auto-sync" and "Notifications" are both toggled on
- Try clicking "Sync Current Page Now" manually

**Profile not updating**
- Go to [orbit dashboard](https://orbit-your-career-compass.daksh25chawla.workers.dev/profile) to verify profile was updated
- Check Railway deploy logs for any errors
